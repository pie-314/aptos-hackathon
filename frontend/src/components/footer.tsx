      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <span className="text-white text-3xl font-extrabold tracking-tight gradient-text">TraceChain</span>
            </div>
            <p className="text-white/70 mb-6 max-w-md leading-relaxed">
              Revolutionizing product authenticity through blockchain technology. 
              Secure, transparent, and trustworthy verification for brands and consumers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="#for-brands" className="text-white/70 hover:text-white transition-colors">For Brands</Link></li>
              <li><Link href="#consumers" className="text-white/70 hover:text-white transition-colors">For Consumers</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#api" className="text-white/70 hover:text-white transition-colors">API Reference</Link></li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            <span className="text-white/70">© 2024 TraceChain. All rights reserved.</span>
          </div>
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white/70 text-sm">Aptos Network</span>
            </div>
          </div>
        </div>
      </div>
